    ...
    <>
      <Layout pageName="Home" pageDescription="Home">
        ...
        {/* <div className="text-center p-10 bg-white">
            ...
            <p className="text-lg">
              Enter our office today, and you can expect premier customer
              service, starting with a low cost diagnostic test and a free quote
              for repairs with no obligation to purchase. With waiting times as
              short as 30 minutes and a large stock of high quality parts, and
              ...
              warranty plans on all repairs, and it’s no wonder that LML Repair
              is Seattle’s first choice for electronic repairs.
            </p>
            ...
            <p className="text-lg">
              ...
              afforable warranty plans – use our fast device repair services
              with confidence and leave with peace of mind that we’ve got your
        ...
        {/* <div className="bg-yellow-300 text-center p-10 bg-white">
            ...
            <h1 className="text-2xl font-bold">
              BEST REPAIR SERVICE IN SEATTLE
            </h1>
            <p className="text-lg my-5">
              LML Repair offers Seattle’s friendliest, fastest repair service
              with expert repairs for a variety of iPhone, iPad, Apple Watch,
              MacBook, Samsung, Pixel, Surface Pro, Nintendo Switch,
              Playstation, Xbox, LG, Oneplus, Motorola, PC devices. <br />
              And, with an affordable warranty plans on all repairs, we’ve got
              your back when things go wrong in future
            </p>
          </div> */}

        <div className="elfsight-app-46eba886-4955-417d-9e36-b02ca1a0e69b p-10 mx-5 md:mx-16"></div>

        <div className="elfsight-app-21af9976-08a4-410b-ab8c-1a076f700795 p-10 mx-5 md:mx-16"></div>

        <div className="elfsight-app-9ea36a6a-a2d4-43b8-9084-5610880cc84f p-10 mx-5 md:mx-16"></div>
        <Faqs />
